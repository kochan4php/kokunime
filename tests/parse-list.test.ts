...
// Fixture mirrors the real kusonime.com list markup (verified Aug 2026):
// kover > thumb (image link with srcset) + content (h2 title, 3 <p>: posted by / released on / genre links)
const html = `
<html><body><div class="venutama">
  <div class="venz"><ul>
    <div class="kover">
      <div class="thumb"><a href="https://kusonime.com/anime-foo/"><div class="thumbz"><img src="https://example.com/foo-150.jpg" srcset="https://example.com/foo-150.jpg 150w, https://example.com/foo-300.jpg 300w, https://example.com/foo.jpg 1000w" /></div></a></div>
      <div class="content">
        <h2 class="episodeye"><a href="https://kusonime.com/anime-foo/">Anime Foo</a></h2>
        <p>Posted by Admin</p>
        <p>Released on 3:54 pm</p>
        <p>Genre <a href="https://kusonime.com/genres/action/">Action</a>, <a href="https://kusonime.com/genres/adventure/">Adventure</a></p>
      </div>
    </div>
  </ul></div>
</div></body></html>`;
...
describe("formatAnimeData", () => {
  ...
  it("falls back to src when srcset is absent", () => {
    const sparse = `<div class="venutama"><div class="venz"><ul><div class="kover">
      ...
      <div class="content"><h2><a href="https://kusonime.com/anime-foo/">Anime Foo</a></h2><p>Posted by Admin</p></div>
    </div></ul></div></div>`;
